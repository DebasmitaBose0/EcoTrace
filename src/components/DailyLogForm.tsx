      ...
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <label className="block text-xs font-medium text-slate-500 mb-1">Miles Driven (Gas Car)</label>
              <input
                type="number"
                min="0"
                max="500"
            ...
            <div>
              <label className="block text-xs font-medium text-slate-500 mb-1">Miles Public Transit</label>
              <input
                type="number"
                min="0"
                max="500"
            ...
            <div>
              <label className="block text-xs font-medium text-slate-500 mb-1">Biked, Walked, or Skated (mi)</label>
              <input
                type="number"
                min="0"
                max="100"
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <label className="block text-xs font-medium text-slate-500 mb-1">Red Meat Portions (Beef/Pork)</label>
              <input
                type="number"
                min="0"
                max="10"
            ...
            <div>
              <label className="block text-xs font-medium text-slate-500 mb-1">Poultry, Fish, or Egg Portions</label>
              <input
                type="number"
                min="0"
                max="10"
            ...
            <div>
              <label className="block text-xs font-medium text-slate-500 mb-1">Fully Plant-Based Meals</label>
              <input
                type="number"
                min="0"
                max="10"
          ...
          <div>
            <label className="block text-xs font-medium text-slate-500 mb-1.5">How much edible food went to waste today?</label>
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2.5">
            <label className="flex items-center space-x-3 p-3 bg-slate-50 rounded-xl hover:bg-slate-100/70 border border-slate-100 transition cursor-pointer">
              <input
                type="checkbox"
        ...
        {/* SHORT NOTES */}
        <div>
          <label className="block text-xs font-semibold text-slate-500 mb-1">Activity Notes / Reflection (Optional)</label>
          <input
            type="text"
            value={notes}
